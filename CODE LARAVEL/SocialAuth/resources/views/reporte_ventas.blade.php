...
<table width="600">
  ...
  <tr>
    <td>
      @foreach($ventas as $p)
    <p><b>Usuario: </b> {{$p->name}} <br>
    <b>Puesto: </b> @if($p->perfil_id==2) Administrador @else General @endif <br>
...
<h3><b>Reporte de Ventas</b></h3><br>
...
<div class="row" style="margin-left: 490px;"><b>TOTAL VENTA: $ {{$total}}.00</b></div><br><br><br>
