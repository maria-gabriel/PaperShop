   ...
   <div class="row justify-content-center">
        ...
        <div class="card-header">{{ __('Ingrese los datos que se solicitan para los detalles de la venta') }}</div>
            <div style="padding: 20px;">
                <form action="{{ route('modificandoVenta',$ven->id) }}" class="newsletterForm" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <input class="form-control" type="text" name="can" id="can" value="{{$ven->cantidad}}">
